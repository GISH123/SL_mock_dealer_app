...
# Linux launcher for mock_dealer_app PyInstaller dist package.
# Put this file inside the dist/ folder, next to generate_ssl.sh.
...
# pm2 start dealer_gui_exec/dealer_gui_exec              --name dealer_gui # OPTIONAL, linux cannot load tkinter
